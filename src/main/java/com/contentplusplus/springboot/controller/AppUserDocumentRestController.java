...
public class AppUserDocumentRestController {
    ...
    public ResponseEntity<Resource> downloadFile(@PathVariable String fileId) {
        ...
        return ResponseEntity.ok()
                .contentType(MediaType.parseMediaType(appUserDocument.getDbfileType()))
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=\"" + appUserDocument.getDbfileName() + "\"")
